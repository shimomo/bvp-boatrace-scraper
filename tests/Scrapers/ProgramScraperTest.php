...
final class ProgramScraperTest extends TestCase
{
    ...
    public function testScrapeWithDate20170331AndRaceStadiumCode24AndRaceCode1(): void
    {
        ...
        $this->assertSame(1, $response['boats'][1]['racer_class_number']);
        $this->assertSame(3, $response['boats'][2]['racer_class_number']);
        $this->assertSame(3, $response['boats'][3]['racer_class_number']);
        $this->assertSame(3, $response['boats'][4]['racer_class_number']);
        $this->assertSame(3, $response['boats'][5]['racer_class_number']);
        $this->assertSame(4, $response['boats'][6]['racer_class_number']);
        $this->assertSame(18, $response['boats'][1]['racer_branch_number']);
        $this->assertSame(42, $response['boats'][2]['racer_branch_number']);
        $this->assertSame(41, $response['boats'][3]['racer_branch_number']);
        $this->assertSame(34, $response['boats'][4]['racer_branch_number']);
        $this->assertSame(13, $response['boats'][5]['racer_branch_number']);
        $this->assertSame(42, $response['boats'][6]['racer_branch_number']);
        $this->assertSame(18, $response['boats'][1]['racer_birthplace_number']);
        $this->assertSame(42, $response['boats'][2]['racer_birthplace_number']);
        $this->assertSame(41, $response['boats'][3]['racer_birthplace_number']);
        $this->assertSame(38, $response['boats'][4]['racer_birthplace_number']);
        $this->assertSame(14, $response['boats'][5]['racer_birthplace_number']);
        $this->assertSame(23, $response['boats'][6]['racer_birthplace_number']);
    ...
    public function testScrapeWithDate20191014AndRaceStadiumCode2AndRaceCode1(): void
    {
        ...
        $this->assertNull($response['boats'][1]['racer_class_number']);
        $this->assertNull($response['boats'][2]['racer_class_number']);
        $this->assertNull($response['boats'][3]['racer_class_number']);
        $this->assertNull($response['boats'][4]['racer_class_number']);
        $this->assertNull($response['boats'][5]['racer_class_number']);
        $this->assertNull($response['boats'][6]['racer_class_number']);
        $this->assertNull($response['boats'][1]['racer_branch_number']);
        $this->assertNull($response['boats'][2]['racer_branch_number']);
        $this->assertNull($response['boats'][3]['racer_branch_number']);
        $this->assertNull($response['boats'][4]['racer_branch_number']);
        $this->assertNull($response['boats'][5]['racer_branch_number']);
        $this->assertNull($response['boats'][6]['racer_branch_number']);
        $this->assertNull($response['boats'][1]['racer_birthplace_number']);
        $this->assertNull($response['boats'][2]['racer_birthplace_number']);
        $this->assertNull($response['boats'][3]['racer_birthplace_number']);
        $this->assertNull($response['boats'][4]['racer_birthplace_number']);
        $this->assertNull($response['boats'][5]['racer_birthplace_number']);
        $this->assertNull($response['boats'][6]['racer_birthplace_number']);

...
final class ScraperCoreTest extends TestCase
{
    ...
    public function testProgramsWithDate20170331AndRaceStadiumCode24(): void
    {
        ...
        $this->assertSame(1, $response[24][1]['boats'][1]['racer_class_id']);
        $this->assertSame(3, $response[24][1]['boats'][2]['racer_class_id']);
        $this->assertSame(3, $response[24][1]['boats'][3]['racer_class_id']);
        $this->assertSame(3, $response[24][1]['boats'][4]['racer_class_id']);
        $this->assertSame(3, $response[24][1]['boats'][5]['racer_class_id']);
        $this->assertSame(4, $response[24][1]['boats'][6]['racer_class_id']);
        $this->assertSame(18, $response[24][1]['boats'][1]['racer_branch_id']);
        $this->assertSame(42, $response[24][1]['boats'][2]['racer_branch_id']);
        $this->assertSame(41, $response[24][1]['boats'][3]['racer_branch_id']);
        $this->assertSame(34, $response[24][1]['boats'][4]['racer_branch_id']);
        $this->assertSame(13, $response[24][1]['boats'][5]['racer_branch_id']);
        $this->assertSame(42, $response[24][1]['boats'][6]['racer_branch_id']);
        $this->assertSame(18, $response[24][1]['boats'][1]['racer_birthplace_id']);
        $this->assertSame(42, $response[24][1]['boats'][2]['racer_birthplace_id']);
        $this->assertSame(41, $response[24][1]['boats'][3]['racer_birthplace_id']);
        $this->assertSame(38, $response[24][1]['boats'][4]['racer_birthplace_id']);
        $this->assertSame(14, $response[24][1]['boats'][5]['racer_birthplace_id']);
        $this->assertSame(23, $response[24][1]['boats'][6]['racer_birthplace_id']);
    ...
    {
        $this->assertSame($this->stadiums, $this->scraper->scrapeStadiums('2017-03-31'));
    }
    ...
    {
        $this->assertSame(array_keys($this->stadiums), $this->scraper->scrapeStadiumIds('2017-03-31'));
    }
    ...
    {
        $this->assertSame(array_values($this->stadiums), $this->scraper->scrapeStadiumNames('2017-03-31'));
    }
}
